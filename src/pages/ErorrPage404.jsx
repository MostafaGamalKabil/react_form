  ...
  return (
    <div className="not-found parallax">
      <Helmet>
        ...
        <style type="text/css">{`@import url("https://fonts.googleapis.com/css?family=Open+Sans|PT+Sans+Narrow");
body {
  overflow: hidden;
...
@keyframes wave-message {
  ...
  100% {
    ...
    transform: translate3d(0, 0, 0);
      ...
      <a className="wave-island" href="https://reactform-a309c.web.app/">
        <img
